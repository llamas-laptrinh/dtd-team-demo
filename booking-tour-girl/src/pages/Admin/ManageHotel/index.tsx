...
import { HotelData } from "../../../types/common";
import { initFlowbite } from "flowbite";

async function createHotel(hotelData: HotelData, accessToken: string) {
    try {
        const response = await axios.post('http://127.0.0.1:8000/api/hotel', hotelData, {
            headers: {
...
async function updateHotel(hotelId: number, updatedData: HotelData, accessToken: string) {
    try {
        const response = await axios.put(`http://127.0.0.1:8000/api/hotel/${hotelId}`, updatedData, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${accessToken}`
            }
...
async function deleteHotel(hotelId: number, accessToken: string) {
    try {
        const response = await axios.delete(`http://127.0.0.1:8000/api/hotel/${hotelId}`, {
            headers: {
                'Authorization': `Bearer ${accessToken}`
            }
        });
...
async function getAllHotels(accessToken: string) {
    try {
...
const ManageHotel: React.FC = () => {
    ...
    useEffect(() => {
        getAllHotels('').then(tickets => {
            console.log('All hotels:', tickets.data);
            setHotels(tickets.data)
            initFlowbite()
                                ...
                                <ul className="pb-2 space-y-2">
                                    <li>
                                        <form action="#" method="GET" className="lg:hidden">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input type="text" name="email" id="mobile-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-200 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" />
                                            </div>
                                        </form>
                                    </li>
                                    <li>
                                        <p className="hover:cursor-pointer flex items-center p-2 text-base text-gray-900 rounded-lg bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                    ...
                                    <li>
                                        ...
                                        <ul id="dropdown-crud" className="space-y-2 py-2 ">
                                            <li>
                                                <p className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-50 dark:bg-gray-700">Hotel</p>
                                            </li>
                                            <li>
                                                <Link to='/admin/manageTicket' className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-50 dark:bg-gray-700">Ticket</Link>
                                            </li>
                                        </ul >
                                    </li >
                                    <li>
            ...
            <div id="main-content" className="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900">
                ...
                <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
                    <div className="w-full mb-1">
                            ...
                            <nav className="flex mb-5" aria-label="Breadcrumb">
                                <ol className="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                                    <li className="inline-flex items-center">
                                        <a href="#" className="inline-flex items-center text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-white">
                                    ...
                                    {/* <li>
                                        <div className="flex items-center">
                                            ...
                                            <a href="#" className="ml-1 text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">E-commerce</a>
                                        </div>
                                    </li> */}
                                    <li>
                                        <div className="flex items-center">
                                            <svg className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                                            <span className="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Hotels</span>
                                        </div>
                                    </li>
                                </ol>
                            </nav>
                            <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All hotels</h1>
                        </div>
                        <div className="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                            ...
                            }} id="createProductButton" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-create-product-default" data-drawer-show="drawer-create-product-default" aria-controls="drawer-create-product-default" data-drawer-placement="right">
                                Add new hotel
                            </button>
                        </div>
                    </div>
                                            ...
                                            return (
                                                <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    ...
                                                    <td className="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        <div className="text-base font-semibold text-gray-900 dark:text-white">{hotel.name}</div>
                                                        <div className="text-sm font-normal text-gray-500 dark:text-gray-400">{hotel.hotel_type}</div>
                                                    </td>
                                                    <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{hotel.address}</td>
                                                    <td className="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{hotel.hotel_policy}</td>
                                                    {/* <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">#{hotel.hotel_services}</td> */}
                                                    {/* <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{hotel.price_per_night}</td> */}
                                                    {/* <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{hotel.rating}</td> */}
                                                    ...
                                                    <td className="p-4 space-x-2 whitespace-nowrap">
                                                        <button onClick={() => {
                                                            ...
                                                            setPolicies(hotel.hotel_policy)
                ...
                <div className="sticky bottom-0 right-0 items-center w-full p-4 bg-white border-t border-gray-200 sm:flex sm:justify-between dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="flex items-center space-x-3">
                        <a href="#" className="inline-flex items-center justify-center flex-1 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <div id="drawer-update-product-default" className="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabIndex={-1} aria-labelledby="drawer-label" aria-hidden="true">
                    <h5 id="drawer-label" className="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Update Hotel</h5>
                    ...
                    <form action="#">
                        ...
                        <div className="bottom-0 left-0 flex justify-center w-full pb-4 mt-4 space-x-4 sm:absolute sm:px-4 sm:mt-0">
                            <button onClick={(e) => {
                                ...
                                updateHotel(ID, { name: name, address: address, hotel_policy: policies }, '')
                                    .then(() => {
                                        getAllHotels('').then(Hotels => {
                                            console.log('All Hotels:', Hotels.data);
                            ...
                            <button
                                onClick={() => setID(hotel.id)}
                                type="button" className="w-full justify-center text-red-600 inline-flex items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                ...
                <div id="drawer-delete-product-default" className="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabIndex={-1} aria-labelledby="drawer-label" aria-hidden="true">
                    ...
                    <h3 className="mb-6 text-lg text-gray-500 dark:text-gray-400">Are you sure you want to delete this hotel?</h3>
                    <button
                        onClick={(e) => {
                            e.preventDefault()
                    ...
                    <button className="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-blue-300 border border-gray-200 font-medium inline-flex items-center rounded-lg text-sm px-3 py-2.5 text-center dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700" data-drawer-hide="drawer-delete-product-default">
                        No, cancel
                    </button>
                </div>
                ...
                <div id="drawer-create-product-default" className="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabIndex={-1} aria-labelledby="drawer-label" aria-hidden="true">
                    <h5 id="drawer-label" className="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">New hotel</h5>
                    ...
                    <form action="#">
                        <div className="space-y-4">
                            ...
                            <div>
                                <label htmlFor="descriptionAdd" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Policies</label>
                                <textarea id="descriptionAdd" rows={4} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter policies" onChange={(e) => setPolicies(e.target.value)} value={policies}></textarea>
                            </div>
                            ...
                            <div className="bottom-0 left-0 flex justify-center w-full pb-4 space-x-4 md:px-4 md:absolute">
                                <button
                                    onClick={(e) => {
                                        ...
                                        createHotel({ name: name, address: address, hotel_policy: policies }, '')
                                            .then(() => {
                                                getAllHotels('').then(Hotels => {
                                                    console.log('All Hotels:', Hotels.data);
                                                    setHotels(Hotels.data)
                                    ...
                                    type="submit" className="text-white w-full justify-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Add hotel
                                </button>
                                <button type="button" data-drawer-dismiss="drawer-create-product-default" aria-controls="drawer-create-product-default" className="inline-flex w-full justify-center text-gray-500 items-center bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
