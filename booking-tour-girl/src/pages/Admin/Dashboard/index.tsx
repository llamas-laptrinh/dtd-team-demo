...
import iphoneImage from "../../../assets/images/products/iphone.png"
                                ...
                                <ul className="pb-2 space-y-2">
                                    ...
                                    <li>
                                        ...
                                        <ul id="dropdown-crud" className="hidden space-y-2 py-2 ">
                                            <li>
                                                <a href="" className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-50 dark:bg-gray-700">Hotel</a>
                                            </li>
                                            <li>
                                                <a href="" className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-50 dark:bg-gray-700">Ticket</a>
                                            </li>
                                        </ul >
                                    </li >
                                    <li>
                                        ...
                                        <li className="py-3 sm:py-4">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center min-w-0">
                                                    <img className="flex-shrink-0 w-10 h-10" src={iphoneImage} alt="imac image" />
                                                    <div className="ml-3">
